...
-- CreateIndex
CREATE INDEX "AuditRecord_actorId_occurredAt_idx" ON "AuditRecord"("actorId", "occurredAt");

-- CreateIndex
CREATE INDEX "AuditRecord_resourceType_resourceId_idx" ON "AuditRecord"("resourceType", "resourceId");
